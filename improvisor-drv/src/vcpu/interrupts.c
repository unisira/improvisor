...
/*++
Routine Description:
	Handle host exceptions. In the debug build, if this function returns FALSE, the interrupt will be 'emulated'
	by resuming the VM at a function that immediately executes `int 3`, RSP will be set to the stack pointer passed
	to the exception handler through `VCPU_TRAP_FRAME::Rsp`
--*/
{
