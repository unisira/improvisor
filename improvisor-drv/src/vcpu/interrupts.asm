...
__vmm_generic_intr_handler proc
	...
	add rsp, 08h							; Skip the vector on the stack
	...
	; VMRESUME failed, guest state is corrupted
	int 3
...
VMM_INTR_HANDLER_W_ERR macro vector: req, name: req
name proc
	push vector
...
VMM_INTR_HANDLER_W_ERR 	8, __vmm_intr_gate_8
VMM_INTR_HANDLER 		9, __vmm_intr_gate_9
VMM_INTR_HANDLER_W_ERR	10, __vmm_intr_gate_10
VMM_INTR_HANDLER_W_ERR	11, __vmm_intr_gate_11
VMM_INTR_HANDLER_W_ERR	12, __vmm_intr_gate_12
VMM_INTR_HANDLER_W_ERR	13, __vmm_intr_gate_13
VMM_INTR_HANDLER_W_ERR	14, __vmm_intr_gate_14
